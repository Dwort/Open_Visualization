    ...
    return (
        <div className="terms-main-container">
            ...
            <div className="terms-data-container">
                <div className="custom-terms-offcanvas-style">
                    <OffCanvas />
                </div>
                <div className="terms-text-block">
                    <h2><strong>Terms and Conditions</strong></h2>
                    <p>Welcome to Open Visualization!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of PolyTex's Website,
                        located at OpenVisualization.com.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        Open Visualization if you do not agree to take all of the terms and conditions stated on this page.</p>
                    ...
                    <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                        ...
                        prevailing law of us. Any use of the above terminology or other words in the singular, plural,
                        capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>

                    <h3><strong>Cookies</strong></h3>

                    <p>We employ the use of cookies. By accessing Open Visualization, you agreed to use cookies in agreement
                        with the PolyTex's Privacy Policy. </p>
                    ...
                    <p>Unless otherwise stated, PolyTex and/or its licensors own the intellectual property rights for all material
                        on Open Visualization. All intellectual property rights are reserved. You may access this from Open
                        Visualization for your own personal use subjected to restrictions set in these terms and conditions.</p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Open Visualization</li>
                        <li>Sell, rent or sub-license material from Open Visualization</li>
                        <li>Reproduce, duplicate or copy material from Open Visualization</li>
                        <li>Redistribute content from Open Visualization</li>
                    </ul>

                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                        certain areas of the website. PolyTex does not filter, edit, publish or review Comments prior to their
                        presence on the website. Comments do not reflect the views and opinions of PolyTex,its agents and/or
                        affiliates. Comments reflect the views and opinions of the person who post their views and opinions.
                        To the extent permitted by applicable laws, PolyTex shall not be liable for the Comments or for any
                    ...
                    <p>PolyTex reserves the right to monitor all Comments and to remove any Comments which can be considered
                    ...
                    <p>You hereby grant PolyTex a non-exclusive license to use, reproduce, edit and authorize others to use,
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                        ...
                        absence of PolyTex; and (d) the link is in the context of general resource information.</p>
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                        website, you must inform us by sending an e-mail to PolyTex. Please include your name, your organization
                    ...
                    <p>No use of PolyTex's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
                    ...
                    <div className="terms-copyright">
                        <p><strong>PolyTex. All rights copyright reserved © 2024</strong></p>
                        <p><strong>OpenVisualization.com</strong></p>
                    </div>
                </div>
            </div>
        </div>
